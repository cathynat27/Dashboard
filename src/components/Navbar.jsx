  ...
  return (
    <header className="flex items-center pt-8 pb-6 px-6">
      ...
      <div className="flex-1 flex">
        <FontAwesomeIcon
          icon={props.icon}
          className="w-8 h-8 pt-1 text-sky-700"
        ></FontAwesomeIcon>
        <div className="pl-4">
      ...
      <div className="text-sm">
        <ul className="space-x-8 flex">
          <li className="cursor-pointer font-semibold text-white bg-sky-800 hover:bg-sky-700 hover:border-sky-400 rounded border py-2 px-4">
